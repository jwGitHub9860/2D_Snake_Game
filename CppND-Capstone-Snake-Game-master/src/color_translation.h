...
public:
    ...
    color_translation(const unsigned char* defaultHexBodyColor, const unsigned char* defaultHexHeadColor, const unsigned char* defaultHexFoodColor);    // TEST 2 Constructor WITH memory allocation  NOT ALLOWED
